...
public class BookTicket_GUI extends JInternalFrame {
    ...
    private void book() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Please enter a valid seat count (positive number).", "Input Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        if (f.getSeats() < seats) {
            JOptionPane.showMessageDialog(this, "Only " + f.getSeats() + " seat(s) available on this flight.", "Not Enough Seats", JOptionPane.WARNING_MESSAGE);
            return;
        }
