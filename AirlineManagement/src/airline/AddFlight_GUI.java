...
public class AddFlight_GUI extends JInternalFrame {
    ...
    private void addFlight() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Seats must be a positive whole number.", "Input Error", JOptionPane.ERROR_MESSAGE);
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Charges must be a valid positive number.", "Input Error", JOptionPane.ERROR_MESSAGE);
        ...
        JOptionPane.showMessageDialog(this,
                "<html><b>Flight Added!</b><br>ID: " + id + " &nbsp;|&nbsp; " + source + " \u2192 " + destination +
                "<br>Seats: " + seats + " &nbsp;|&nbsp; Price: PKR " + String.format("%.0f", charges) + "</html>",
                "Success", JOptionPane.INFORMATION_MESSAGE);

        txtSource.setText(""); txtDestination.setText(""); txtSeats.setText(""); txtCharges.setText("");
        txtFlightId.setText(AppData.flightData.generateFlightId());
